SELECT 
  ...
  regexp_replace (
   ...
   regexp_replace (
                    ...
                    '<[^>]*>',
                    ''
                  ) AS `Action Implemented (Immediate Action)`,
...
WHERE (
    ...
    LEFT JOIN 
      ...
      (SELECT 
        ...
        GROUP_CONCAT(
          DISTINCT CONCAT(CASE OccurrenceIndicator_Main WHEN  1 THEN '[P]-' ELSE '' END, regexp_replace (
...
WHERE (
  ...
  AND (`TypeOccurrence_Description` = 'FF')
